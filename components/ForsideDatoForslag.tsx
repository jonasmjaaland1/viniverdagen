              ...
              {sortertAlt.map((alt) => {
                ...
                return (
                  ...
                  >
                    ...
                    {/* Synlig "Vis hvem"-knapp */}
                    {totaltSvar > 0 && (
                      <div className="mt-2">
                        <button
                          onClick={() => setVisSvar(visAlle ? null : alt.id)}
                          className="inline-flex items-center gap-1.5 px-2.5 py-1 text-[11px] font-sans bg-wine-700/10 hover:bg-wine-700/20 text-wine-800 rounded-full transition border border-wine-700/20"
                        >
                          <span>👥</span>
                          <span className="font-medium">
                            {visAlle ? 'Skjul' : 'Vis'} svar ({totaltSvar})
                          </span>
                        </button>
                        {visAlle && (
